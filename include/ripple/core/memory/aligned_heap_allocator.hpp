//==--- ripple/core/memory/aligned_heap_allocator.hpp ------ -*- C++ -*- ---==//
//
//                            Ripple - Core
//
...
#ifndef RIPPLE_CORE_MEMORY_ALIGNED_HEAP_ALLOCATOR_HPP
#define RIPPLE_CORE_MEMORY_ALIGNED_HEAP_ALLOCATOR_HPP
...
#endif // RIPPLE_CORE_MEMORY_ALIGNED_HEAP_ALLOCATOR_HPP
